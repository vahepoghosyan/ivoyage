(function() {
    ...
    function initialize() {
        ...
        var cIW = "";
        var mapOptions = {
            center: new gm.LatLng(34.141911, -118.258174),
            zoom: 18,
            scrollwheel: false,
        ...
        var loc1 = new gm.LatLng(34.141911, -118.258174);
...
document.addEventListener("DOMContentLoaded", function(event) {
    ...
    if (document.querySelector(".dropdown-mobile")) {
        $(".dropdown-mobile").on("click", function(e) {
            $(".navbar-dropdown").toggleClass('d-block')
